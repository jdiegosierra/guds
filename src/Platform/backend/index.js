...
var recording_1 = require("./Recordings/Domain/Agregates/recording");
var recordingRepositoryMongoDB_1 = require("./Recordings/Infrastructure/Persistence/recordingRepositoryMongoDB");
var recordingID_1 = require("./Recordings/Domain/ValueObjects/recordingID");
var recording = new recording_1.Recording(new recordingID_1.RecordingID('1'), 0, 'test', 'test.com', 'ehe');
var recordingRepository = new recordingRepositoryMongoDB_1.RecordingRepositoryMongoDB();
uploadRecording_1.uploadRecording(recording, recordingRepository);
